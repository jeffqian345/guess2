...
def showInstructions():
    print('''Instructions:
You are the captain of the Simon, a treasure-hunting ship. You current mission
...
sonar devices update to show how far away the next nearest chest it. The chests
